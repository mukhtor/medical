        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="/style/images/about/about-1.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="/style/images/about/about-2.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="/style/images/about/about-3.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item">
                    <img src="/style/images/about/about-4.jpg" alt="" class="img-fluid w-100">
...
<section class="section team">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="/style/images/team/2.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="/style/images/team/3.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block">
                    <img src="/style/images/team/4.jpg" alt="" class="img-fluid w-100">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 testimonial-wrap offset-lg-6 slick-initialized slick-slider slick-dotted slick-vertical">
                <div class="slick-list draggable" style="height: 233.594px;"><div class="slick-track" style="opacity: 1; height: 2570px; transform: translate3d(0px, -233px, 0px);"><div class="testimonial-block slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 540px;">
                        ...
                        </div><div class="testimonial-block slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide00" aria-describedby="slick-slide-control00" style="width: 540px;">
                            <div class="client-info ">
                        ...
                        </div><div class="testimonial-block slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide01" aria-describedby="slick-slide-control01" style="width: 540px;">
                            <div class="client-info">
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide02" aria-describedby="slick-slide-control02" style="width: 540px;">
                            <div class="client-info">
                                <h4>Good Support!</h4>
                                <span>Kolis Mullar</span>
                            </div>
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide03" aria-describedby="slick-slide-control03" style="width: 540px;">
                            <div class="client-info">
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide" data-slick-index="4" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide04" aria-describedby="slick-slide-control04" style="width: 540px;">
                            <div class="client-info">
                                <h4>Modern Service!</h4>
                                <span>Kolis Mullar</span>
                            </div>
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 540px;">
                            <div class="client-info ">
                                <h4>Amazing service!</h4>
                                <span>John Partho</span>
                            </div>
                        ...
                        </div><div class="testimonial-block slick-slide slick-cloned" data-slick-index="6" aria-hidden="true" tabindex="-1" style="width: 540px;">
                            <div class="client-info">
                                <h4>Expert doctors!</h4>
                                <span>Mullar Sarth</span>
                            </div>
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide slick-cloned" data-slick-index="7" aria-hidden="true" tabindex="-1" style="width: 540px;">
                            <div class="client-info">
                                <h4>Good Support!</h4>
                                <span>Kolis Mullar</span>
                            </div>
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide slick-cloned" data-slick-index="8" aria-hidden="true" tabindex="-1" style="width: 540px;">
                            <div class="client-info">
                                <h4>Nice Environment!</h4>
                                <span>Partho Sarothi</span>
                            </div>
                            ...
                            <i class="icofont-quote-right"></i>
                        </div><div class="testimonial-block slick-slide slick-cloned" data-slick-index="9" aria-hidden="true" tabindex="-1" style="width: 540px;">
                            <div class="client-info">
                                <h4>Modern Service!</h4>
                                <span>Kolis Mullar</span>
                            </div>
